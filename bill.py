...
class Bill(object):
  ...
  """  
  def __init__(self, package_information: object = Package, package_address: object = Address, package_person: object = Person, total_paid: float = 1.5, card_type: str = "Debito/Credito", type_of_financing: str = "99 Cuotas"):
