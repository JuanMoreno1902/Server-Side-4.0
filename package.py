...
class Package(Deliver):
  ...
  W_GR_100 = 1.0
  def __init__(self, id_package: int = 0, weight: float = 0.5 , description: str = "DescriptionOfProduct" , cost: float = 1.5, date: str = "99/99/9999", time: str = "9:99", sender: str = "Person", recive: str = "PersonaQueLoRecibe", sender_add: str = "PersonaQueLoEnvia", recive_add: str = "sssssssssssss", contac: str = "+999999999999", items: str = "Paquetedenvio"):
